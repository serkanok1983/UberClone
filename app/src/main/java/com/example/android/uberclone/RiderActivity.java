                                ...
                                if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                    ...
                                    if (lastKnownLocation != null) {
                                        ...
                                        if (distanceInKm < 0.01 ) {
                                            infoTextView.setText("Şoförünüz geldi!");
                                            ParseQuery<ParseObject> query = ParseQuery.getQuery("Request");
                                            query.whereEqualTo("username", ParseUser.getCurrentUser().getUsername());
                                            query.findInBackground(new FindCallback<ParseObject>() {
                                                @Override
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callUberButton.setText("UBER ÇAĞIR");
                                                    requestActive = false;
                                                    driverActive = false;
                                                }
                                            }, 5000);
                                            ...
                                            infoTextView.setText("Şoförünüz " + distanceOneDP.toString() + " km uzaklıkta!");
                                            ...
                                            mMap.clear();
                                            markers.add(mMap.addMarker(new MarkerOptions().position(driverLocationLatLng).title("Şoför konumu")));
                                            markers.add(mMap.addMarker(new MarkerOptions().position(requestLocationLatLng).title("Konumunuz").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))));
        ...
        if (requestActive) {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                if (lastKnownLocation != null) {
                    ...
                    Toast.makeText(this, "Konum bulunamadı. Tekrar deneyiniz.", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
