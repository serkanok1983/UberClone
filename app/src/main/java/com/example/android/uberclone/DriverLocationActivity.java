    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                markers.add(mMap.addMarker(new MarkerOptions().position(driverLocation).title("Konumunuz")));
                markers.add(mMap.addMarker(new MarkerOptions().position(requestLocation).title("Müşteri konumu").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))));
